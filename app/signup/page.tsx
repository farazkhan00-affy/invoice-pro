    ...
    <div className="min-h-screen flex items-center justify-center px-6 bg-[var(--background)] py-12">
      ...
      >
        ...
        <div className="border border-[var(--border)] rounded-2xl p-8 bg-[var(--card)]">
          ...
          {/* Google signup */}
          <button className="w-full flex items-center justify-center gap-2 border border-[var(--border)] rounded-lg py-2.5 text-sm font-medium text-[var(--foreground)] hover:bg-[var(--border)]/30 transition-colors">
